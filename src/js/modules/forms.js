const formValidation = {
   ...
   filePreview(form) {
      ...
      inputFile.addEventListener('change', (event) => {
         ...
         // якщо необхідно завантажити 1 зображення
         // files = [...sortedFiles];
         // якщо необхідно завантажити багато зображень
         ...
         for (let i = 0; i < files.length; i++) {
            ...
            reader.onload = function(e) {
               ...
               previewImage.alt = 'Завантажене зображення';
      ...
      filesContainer.addEventListener('click', (e) => {
         if (e.target.classList.contains('_file-delete-button')) {
            ...
            // Оновлюємо значення dataset.delete для інших зображень у списку після видалення зображення
